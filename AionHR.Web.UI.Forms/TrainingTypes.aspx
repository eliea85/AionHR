<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingTypes.aspx.cs" Inherits="AionHR.Web.UI.Forms.TrainingTypes" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Scripts/TrainingTypes.js?id=0" ></script>
